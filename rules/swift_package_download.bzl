"""Implementation for `swift_package_download`."""
...
def _clone_or_update_repo(repository_ctx, directory):
    ...
    # sure how to determine that when generating the swift_package_download declarations
...
def _swift_package_download_impl(repository_ctx):
...
""",
    ...
    return _update_git_attrs(repository_ctx.attr, ALL_ATTRS.keys(), update)
...
swift_package_download = repository_rule(
    implementation = _swift_package_download_impl,
    attrs = ALL_ATTRS,
    doc = """\
